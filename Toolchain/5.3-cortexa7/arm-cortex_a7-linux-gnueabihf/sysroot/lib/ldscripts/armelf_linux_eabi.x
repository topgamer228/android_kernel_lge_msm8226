...
OUTPUT_ARCH(arm)
ENTRY(_start)
SEARCH_DIR("=/home/linux/Development/toolchain-builds/arm-cortex_a7-linux-gnueabihf/arm-cortex_a7-linux-gnueabihf/lib"); SEARCH_DIR("=/usr/local/lib"); SEARCH_DIR("=/lib"); SEARCH_DIR("=/usr/lib");
SECTIONS
{
